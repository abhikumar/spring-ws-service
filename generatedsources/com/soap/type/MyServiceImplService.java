 ...
 * 2017-05-25T18:21:09.128+05:30
 * Generated source version: 2.5.1
 * 
 */
@WebServiceClient(name = "MyServiceImplService", 
                  wsdlLocation = "file:/D:/workspace/spring-ws-service/src/main/resources/wsdl/MyService.wsdl",
...
public class MyServiceImplService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/D:/workspace/spring-ws-service/src/main/resources/wsdl/MyService.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(MyServiceImplService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/D:/workspace/spring-ws-service/src/main/resources/wsdl/MyService.wsdl");
        }
        WSDL_LOCATION = url;
    }
